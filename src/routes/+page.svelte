...
<main class="max-w-6xl mx-auto px-4 py-6">
  ...
  <header class="text-center py-8">
    ...
    <p class="text-gray-500 text-sm mt-3">Updated: {new Date(lastUpdatedTimestamp).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric', hour: '2-digit', minute: '2-digit', timeZoneName: 'short' })}</p>
  </header>
  ...
  <footer class="text-center text-gray-500 text-sm py-4">
    ...
    <p>Generated by <a href="https://github.com/wicaksana94" target="_blank" class="text-cyan-400 hover:underline">Arya</a> - {new Date(lastUpdatedTimestamp).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric', hour: '2-digit', minute: '2-digit', timeZoneName: 'short' })}</p>
  </footer>
